...
SELECT * FROM employees WHERE (first_name LIKE '%Irena%' OR first_name LIKE '%Vidya%' OR first_name LIKE '%Maya%') AND gender = 'M';
...
SELECT CONCAT(first_name,' ', last_name), DATEDIFF(now(), hire_date)AS 'Days Working at the Company' FROM employees WHERE (hire_date BETWEEN '1990-01-01' AND '1999-12-31') AND birth_date LIKE '%-12-25' ORDER BY birth_date,hire_date DESC;
